...
/* MIDDLEWARES
Estos se van ejecutando sincrónicamente y podrían servirme por ejemplo para hacer un logueo
y no dejar seguir al usuario si no se loguea antes.
*/
app.use( (req, res, next) => {
    console.log("pase por acá 1");
    next();
});
app.use( (req, res, next) => {
...
// El next hará haciendo que pase al siguiente checkeo, sino se queda ahí trabado.
