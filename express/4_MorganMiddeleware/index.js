...
/* MIDDLEWARES
Son middlewares que sirven para analizar las conexiones. en vez de un simple console.log como lo otro
te da como fue la conexión que se realizo.
Se hace igual que las del ejercicio 3 pero ya no tengo que desarrollar las funciones, alguien las hizo por
mi.
*/
app.use(morgan("dev"));

// No hace falta poner el next porque ya viene incorporado.
